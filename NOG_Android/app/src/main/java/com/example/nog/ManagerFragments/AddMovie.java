...
public class AddMovie extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        submitBtn.setOnClickListener(v -> validateAndSubmit(movieTitleEt, dateEt, chipGroup));
        return rootView;
    }

    private void validateAndSubmit(EditText titleEt, EditText dateEt, ChipGroup chipGroup){
        ...
        submitToServer(title, date, categories);
    }

    private void submitToServer(String titleValue, String date, List<String> categoryList){
        ...
        Call<Void> call = apiService.addMovie(token, title, releaseDate, categories,imagePart, filmPart );
    ...
    // Checking if user already inserted
